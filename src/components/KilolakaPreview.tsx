    ...
    <section id="kilolaka" className="py-24 bg-earth-deep">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <p className="font-mandombe text-3xl text-gold/50 mb-1">Kilolaka</p>
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-cream/5 backdrop-blur rounded-xl p-8 border border-gold/20">
            <p className="font-mandombe text-xl text-gold/40 mb-1">Ki-Lo-La-Ka</p>
              ...
              {[
                ...
                <div key={item.syllable} className="flex gap-4 items-start">
                  <div className="min-w-[60px] text-center">
                    <span className="font-mandombe text-lg text-gold/40 block">{item.syllable}</span>
          ...
          {/* Morpheme table */}
          <div className="bg-cream/5 backdrop-blur rounded-xl p-8 border border-gold/20">
            <p className="font-mandombe text-xl text-terracotta-light/40 mb-1">B-Series</p>
            <h3 className="font-display text-2xl font-bold text-gold mb-6">
              ...
              {[
                ...
                >
                  <div className="min-w-[40px] text-center">
                    <span className="font-mandombe text-sm text-terracotta-light/40 block">{item.morpheme}</span>
