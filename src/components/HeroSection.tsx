  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center max-w-4xl">
        <p className="font-mandombe text-3xl md:text-5xl text-gold/60 mb-2 animate-fade-in opacity-0" style={{ animationDelay: "0.1s" }}>
          Nzo Mikanda
        </p>
        <p className="text-gold font-body text-lg tracking-[0.3em] uppercase mb-6 animate-fade-in opacity-0" style={{ animationDelay: "0.2s" }}>
