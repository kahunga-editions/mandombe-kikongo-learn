...
export const lessons: Lesson[] = [
  ...
  },
  {
    ...
    icon: "🥁",
    vocabulary: [
      { lari: "Biéka", mandombe: "Bieka", french: "Bénir, consacrer, mettre à part", english: "To bless, to consecrate, to set apart" },
      { lari: "Séma", mandombe: "Sema", french: "Bénir", english: "To bless" },
      { lari: "Biéko", mandombe: "Bieko", french: "Béni, saint, sacré", english: "Blessed, holy, sacred" },
      { lari: "Tumbu", mandombe: "Tumbu", french: "Béni, saint, sacré", english: "Blessed, holy, sacred" },
      { lari: "Biélangana", mandombe: "Bielangana", french: "Résonner (cloche, tam-tam)", english: "To resonate (bell, drum)" },
      { lari: "Biétana", mandombe: "Bietana", french: "Sonner, se faire entendre", english: "To ring, to be heard" },
      { lari: "Biétasa", mandombe: "Bietasa", french: "Entrechoquer, faire résonner", english: "To clash, to make resonate" },
      { lari: "Biémba", mandombe: "Biemba", french: "Tabasser, frapper durement", english: "To beat up, to strike hard" },
      ...
      { lari: "Biolé", mandombe: "Biole", french: "Deux (pour les choses)", english: "Two (for things)" },
      ...
      { lari: "Bifiéngo", mandombe: "Bifiengo", french: "Instrument de chasse (pipeau)", english: "Hunting instrument (pipe whistle)" },
    ...
    exercises: [
      ...
      {
        type: "multiple-choice",
        question: "What does 'Biélangana' mean?",
      ...
      {
        type: "multiple-choice",
        question: "What does 'Biémba' mean?",
      ...
      },
      {
        ...
        pairs: [
          { left: "Biélangana", right: "To resonate" },
          { left: "Biétana", right: "To ring" },
          { left: "Biétasa", right: "To clash together" },
      ...
      },
      {
        ...
        pairs: [
          { left: "Biéka", right: "To bless" },
          { left: "Biéko", right: "Blessed, sacred" },
          { left: "Séma", right: "To bless" },
  ...
  },
  {
    ...
    vocabulary: [
      ...
      { lari: "Buléké", mandombe: "Buleke", french: "Jeunesse, adolescence", english: "Youth, adolescence" },
      { lari: "Bulémbé", mandombe: "Bulembe", french: "Lenteur", english: "Slowness" },
      { lari: "Bulémvov", mandombe: "Bulemvov", french: "Humilité, obéissance, respect", english: "Humility, obedience, respect" },
    ...
    phrases: [
      { lari: "Bulémvov bua muntu", mandombe: "Bulemvov bua muntu", french: "L'humilité de l'être humain", english: "The humility of a human being" },
    ...
    exercises: [
      {
        type: "multiple-choice",
        question: "What does 'Bulémvov' mean?",
        questionMandombe: "Bulemvov",
      ...
      },
      {
        ...
        sentenceMandombe: "___",
        blank: "bulémvov",
        hint: "Related to the verb 'lembvoca' (to humble oneself)",
      },
      {
        type: "fill-in-blank",
  ...
  },
  {
    ...
    vocabulary: [
      ...
      { lari: "Bingi", mandombe: "Bingi", french: "Nombreux", english: "Numerous, many" },
      { lari: "Bibyengélé", mandombe: "Bibyengele", french: "Menottes", english: "Handcuffs" },
