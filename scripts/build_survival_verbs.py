...
verb(
    ...
    [
        ...
        tense("Pouvoir se battre", "To be able to fight",
              ["Ndendi nuana", "Lendi nuana", "Lendi nuana", "tu lendi nuana",
               "lu lendi nuana", "ba lendi nuana"],
              ["Je peux me battre.", "Tu peux te battre.", "Il peut se battre.",
               "Nous pouvons nous battre.", "Vous pouvez vous battre.",
               "Ils peuvent se battre."],
              ["I can fight.", "You can fight.", "He can fight.", "We can fight.",
               "You (pl.) can fight.", "They can fight."],
              ["Ndendi", "Lendi", "Lendi", "lendi", "lendi", "lendi"]),
        tense("Pouvoir se battre — passé", "To be able to fight — past",
              ["na lendi nuana", "wa lendi nuana", "wa lendi nuana",
               "ta lendi nuana", "lua lendi nuana", "ba lendi nuana"],
              ["Je pouvais me battre.", "Tu pouvais te battre.", "Il pouvait se battre.",
               "Nous pouvions nous battre.", "Vous pouviez vous battre.",
               "Ils/Elles pouvaient se battre."],
              ["I could fight.", "You could fight.", "He could fight.", "We could fight.",
        ...
        tense("Pouvoir travailler", "To be able to work",
              ...
              ["ndendi", "lendi", "lendi", "lendi", "lendi", "lendi"]),
         tense("Pouvoir manger", "To be able to eat",
               ["ndendi dia", "lendi dia", "lendi dia", "tu lendi dia",
                "lu lendi dia", "ba lendi dia"],
               ["Je peux manger.", "Tu peux manger.", "Il/Elle peut manger.",
                "Nous pouvons manger.", "Vous pouvez manger.",
                "Ils/Elles peuvent manger."],
               ["I can eat.", "You can eat.", "He/She can eat.", "We can eat.",
                "You (pl.) can eat.", "They can eat."],
               ["ndendi", "lendi", "lendi", "lendi", "lendi", "lendi"]),
         tense("Pouvoir manger — négatif", "To be able to eat — negative",
               ["ka ndendi a dia ko", "ku lendi a dia ko", "ka lendi a dia ko",
                "ka tu lendi a dia ko", "ka lu lendi a dia ko", "ka ba lendi a dia ko"],
               ["Je ne peux pas manger.", "Tu ne peux pas manger.",
                "Il/Elle ne peut pas manger.", "Nous ne pouvons pas manger.",
                "Vous ne pouvez pas manger.", "Ils/Elles ne peuvent pas manger."],
               ["I cannot eat.", "You cannot eat.", "He/She cannot eat.",
                "We cannot eat.", "You (pl.) cannot eat.", "They cannot eat."],
               ["ndendi", "lendi", "lendi", "lendi", "lendi", "lendi"],
               None, "ka + lendi + a + verbe + ko"),
    ...
    [
        ...
        tense("Devoir travailler — forme avec thème", "To have to work — with theme",
              ...
              ["I must work.", "You must work.", "He/She must work.", "We must work.",
               "You (pl.) must work.", "They must work."],
               ["mfueti", "fueti", "fueti", "fueti", "fueti", "fueti"]),
        tense("Devoir manger", "To have to eat",
              ["mfueti dia"],
              ["Je dois manger."],
              ["I must eat."],
              ["mfueti"],
...
verb(
    ...
    [
        ...
        tense("Passé négatif", "Past negative",
              ["ka na zaba a ko", "ka wa zaba a ko", "ka zaba a ko",
               "ka ta zaba a ko", "ka lua zaba a ko", "ka ba zaba a ko"],
              frv("ne savais pas / ne connaissais pas",
                  "ne savais pas / ne connaissais pas",
                  "ne savait pas / ne connaissait pas",
                  "ne savions pas / ne connaissions pas",
                  "ne saviez pas / ne connaissiez pas",
                  "ne savaient pas / ne connaissaient pas"),
              env("did not know", "did not know", "did not know",
                  "did not know", "did not know", "did not know"),
              "zaba", None, "ka + particule du pronom + verbe + a ko"),
...
verb(
    ...
    [
        ...
        tense(*PAST, ["njelele", "yelele", "yelele", "tu yelele", "lu yelele", "ba yelele"],
         ...
         tense("Essayer d'appeler", "To try to call",
               ["Njelele mu ta mbila", "yelele mu ta mbila", "yelele mu ta mbila",
                "tu yelele mu ta mbila", "lu yelele mu ta mbila", "ba yelele mu ta mbila"],
               ["J'essaie d'appeler.", "Tu essaies d'appeler.", "Il/Elle essaie d'appeler.",
                "Nous essayons d'appeler.", "Vous essayez d'appeler.",
                "Ils/Elles essaient d'appeler."],
               ["I try to call.", "You try to call.", "He/She tries to call.",
                "We try to call.", "You (pl.) try to call.", "They try to call."],
               ["Njelele", "yelele", "yelele", "yelele", "yelele", "yelele"]),
...
verb(
    ...
    [
        ...
        tense(*PAST, ["nzakase", "zakase", "zakase", "tu zakase", "tu zakase", "ba zakase"],
              ...
              {3: "Le document écrit touzacassé pour le pluriel : Biba tu zakase = nous avons assis les ancêtres."}),
